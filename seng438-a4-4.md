...
Equivalent mutants make it harder to fulfill the core purpose of mutation score accuracy, which is to see how good or bad our tests are. Because these equivalent mutants exist and survive, it becomes harder to report an accurate picture of our testing suite to outside parties, as at a glance a score that looks low could just be held back by equivalence and there's no way to tell without digging deeper. 
